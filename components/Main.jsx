...
export default function Main(props){
    ...
    return (
        <>
            ...
            <div className="w-96 h-3/4 bg-blue-200 rounded-xl border-solid border-2 border-black p-5 overflow-hidden">
                ...
                <div className=" w-full h-14 backdrop-blur-sm bg-amber-400 rounded-xl flex justify-evenly items-center">
                    ...
                    <button onClick={addTaskButton} className="bg-blue-200 hover:bg-blue-500 text-black hover:text-white font-bold py-4 px-4 rounded-full flex items-center space-x-2">
